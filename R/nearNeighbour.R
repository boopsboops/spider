...
#' 
#' These functions test barcoding efficacy and are not identification tools.
#' All sequences must be identified prior to testing. Each sequence is
#' considered an unknown while the remaining sequences in the dataset
#' constitute the DNA barcoding database that is used for identification. If
#' the identification from the test is the same as the pre-considered
#' identification, a correct result is returned.
#' 
...
#' Database (\url{http://www.boldsystems.org/views/idrequest.php}). It is more
#' inclusive than \code{bestCloseMatch}, considering ALL sequences within the
#' given threshold.
#' 
